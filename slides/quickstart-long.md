...
Il est possible d'ajouter les notes _note_, _tip_, _important_, _warning_ et _danger_ en ajoutant la classe adéquate au _blockquote_. 
...
<!-- class: warning -->
>**Attention**
> Comme il s'agit d'une classe, il n'est pas possible d'en mettre 2≠ / slide..
